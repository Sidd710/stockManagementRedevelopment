<%@ Page Title="" Language="C#" MasterPageFile="~/RHPD.Master" AutoEventWireup="true" CodeBehind="SupplierMgmt.aspx.cs" Inherits="RHPDNew.Forms.SupplierMgmt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="heading-bg" align="center" >
            <div class="container">
                <h1  style="background-color:skyblue;color:white">Manage Suppliers</h1>
            </div>
        </div>
         <br />
         <br />
                ...
                <Columns>
                    ...
                    <asp:TemplateField AccessibleHeaderText="Active/In-Active">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:CheckBox ID="chk" Checked=' <%# Eval("IsActivated")%>' runat="server" />
                        </ItemTemplate>
