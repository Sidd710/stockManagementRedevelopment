<%@ Page Title="" Language="C#" MasterPageFile="~/RHPD.Master" AutoEventWireup="true" CodeBehind="ManageFormation.aspx.cs" Inherits="RHPDNew.Forms.ManageFormation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="heading-bg" align="center" >
            <div class="container">
                <h1  style="background-color:skyblue;color:white">Manage Formation</h1>
            </div>
        </div>
         <br />
         <br />
    ...
    <div class="container-fluid form-outer">
        ...
        <div class="container forming_texting">
           ...
           <div class="row marginbottom10">
               <div class="col-ten">
                   <label class="form_text"> Command :</label>
                    
                   <asp:DropDownList ID="ddlCommand" runat="server" DataSourceID="sqlcommandq" DataTextField="Name" OnDataBound="ddlCommand_DataBound" CssClass="col-lg-4 form-control" DataValueField="Id"></asp:DropDownList>
                   <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="grp" runat="server" ErrorMessage="" ForeColor="Red" SetFocusOnError="true"
                         ControlToValidate="ddlCommand" InitialValue="0"></asp:RequiredFieldValidator>
                    <asp:SqlDataSource ID="sqlcommandq" runat="server" ConnectionString='<%$ ConnectionStrings:con %>' SelectCommand="SELECT * FROM [CommandMaster] WHERE ([IsActive] = @IsActive)">
                        <SelectParameters>
        ...
        <div class="container">
            <div class="tableDiv">
                <asp:GridView ID="grdFormation" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" DataKeyNames="Id" AutoGenerateColumns="false" OnRowCommand="GridView1_RowCommand">
                <Columns>
                    ...
                    <asp:TemplateField AccessibleHeaderText="Name">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblCmndName" runat="server" Text='<%# Eval("CommandMaster.Name") %>'></asp:Label>
                        </ItemTemplate>
