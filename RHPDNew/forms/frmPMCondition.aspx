<%@ Page Title="" Language="C#" MasterPageFile="~/RHPD.Master" AutoEventWireup="true" CodeBehind="frmPMCondition.aspx.cs" Inherits="RHPDNew.Forms.frmPMCondition" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        function name() {
            alert('Condition is already exists');
        }
    </script>
    
    <div class="heading-bg" align="center" >
            <div class="container">
                <h1  style="background-color:skyblue;color:white">Manage PM Condition</h1>
            </div>
        </div>
         <br />
         <br />
        ...
        <div class="container forming_texting">
              ...
              <div class="row marginbottom10">
                ...
                <div class="col-five">
                    ...
                    <asp:TextBox runat="server" CssClass="form-control" ID="txtCondition" />
                    <asp:RequiredFieldValidator ID="rfvNameTextBox" runat="server" Text="*"
                        Display="Dynamic" ValidationGroup="grp" ControlToValidate="txtCondition" ErrorMessage="*"
            ...
            <telerik:RadGrid runat="server"  ID="rgdName" Width="100%" AutoGenerateColumns="False" AllowPaging="true" AllowFilteringByColumn="false" Skin="Web20" OnItemCommand="rgdName_ItemCommand">
                <MasterTableView DataKeyNames="Id" Caption="PM Condition List" CommandItemDisplay="Top" Font-Names="Arial" Font-Size="9">
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Condition" DataField="Condition" DataType="System.String" UniqueName="Condition" Groupable="false">
                            <ItemTemplate>
                            ...
                            <ItemTemplate>
                                <div class="">
                                    <asp:LinkButton ID="lkactive" runat="server" Text='<%#Eval("IsActive").ToString()=="False"?"Activate":"InActivate" %>' CausesValidation="false" CommandName="Active" CommandArgument='<%# Eval("ID")+"< "+Eval("Condition")+"< "+ Eval("IsActive").ToString()%>'></asp:LinkButton>&nbsp;&nbsp;
                                    <asp:LinkButton ID="lkedit" runat="server" CausesValidation="false" Text="Edit" CommandName="pEdit" 
                                        CommandArgument='<%# Eval("ID")+"< "+Eval("Condition")
