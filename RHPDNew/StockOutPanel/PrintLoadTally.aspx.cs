...
{
    public partial class PrintLoadTally1 : System.Web.UI.Page
    {
        ...
        private void _GetSummary(DataTable dt)
        {
            try
            {
                ...
                lblCost.Text = "Amount: " + cost.ToString("0.00");
        ...
        {
            int ltID = Convert.ToInt32(Request.QueryString["ltNo"].ToString());
            Response.Redirect("../StockOutPanel/PrintCompactLoadTally.aspx?ltNo=" + ltID);
